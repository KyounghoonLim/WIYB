...
export default function Island_EquipReviews({ id, reviews, reviewCount }: { id: string; reviews: Review[]; reviewCount: number }) {
  return (
    <Island>
      <List items={reviews?.slice(0, 3) || []} Component={ListItem_Review} />
      {reviewCount > 3 && (
