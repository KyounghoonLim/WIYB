...
export default function EquipmentDetailPage({ searchParams: { id } }: { searchParams: { id: string } }) {
  ...
  return (
    <main className="SCROLLABLE-CONTAINER gap-4">
      ...
      <Island_EquipImage imageUrl={equip?.imageUrls[0] || "/images/driver_dummy.png"} />
