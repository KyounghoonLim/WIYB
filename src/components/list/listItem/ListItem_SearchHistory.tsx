...
export default function ListItem_SearchHistory({ item, idx, search, removeSearchHistory }: ListItemProps<string>) {
  ...
  return (
    <div className="list-item gap-2" onClick={itemClickHandler}>
      ...
      <button type="button" className="h-full aspect-auto ml-auto flex-row-center" onClick={removeClickHandler}>
