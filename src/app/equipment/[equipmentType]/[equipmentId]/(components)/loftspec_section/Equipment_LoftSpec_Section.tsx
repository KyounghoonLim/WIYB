...
export default function Equipment_LoftSpec_Section({ equipmentType }: { equipmentType: string }) {
  return (
    <>
      {loftSpecKeys[equipmentType] && (
        <section className="w-[880px] h-auto flex-row-center">
          <article className="w-full h-full flex flex-col justify-evenly gap-3">
            ...
            <Equipment_LoftSpecTable equipmentType={equipmentType} />
          </article>
        </section>
      )}
    </>
